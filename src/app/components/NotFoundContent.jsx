  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-zinc-950 px-4 transition-colors duration-200">
      <div className="text-center space-y-6 max-w-md w-full">
        ...
        <div className="pt-4">
          <Link href="/">
            <Button className="h-12 px-8 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-base rounded-full shadow-lg hover:shadow-indigo-500/20 transition-all flex items-center justify-center gap-2 mx-auto">
